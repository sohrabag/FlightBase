...
//		Command command1 = new Command("process it...");
	    ControlWaiter controlWaiter1 = new ControlWaiter(command1);
	    new Thread(controlWaiter1,"ControlWaiter1").start();
	    
	    ControlWaiter controlWaiter2 = new ControlWaiter(command2);
	    new Thread(controlWaiter2, "controlWaiter2").start();
	    
	    ControlWaiter controlWaiter3 = new ControlWaiter(command3);
	    new Thread(controlWaiter3, "controlWaiter3").start();

	    ControlNotifier controlNotifier1 = new ControlNotifier(command1);
	    new Thread(controlNotifier1, "controlNotifier1").start();

	    ControlNotifier controlNotifier2 = new ControlNotifier(command1);
	    new Thread(controlNotifier2, "controlNotifier2").start();

	    ControlNotifier controlNotifier3 = new ControlNotifier(command1);
